  ...
  <div>
    ...
    <div class="product">
      ...
      <article>
        ...
        <?php if($product->link_shop_ferratec): ?>
          <div class="product__shop">
            <hr>
            <h3><?php echo e(__('page.heading-order-product')); ?></h3>
            <div class="product__shop-buttons">
              <a href="<?php echo e($product->link_shop_ferratec); ?>" target="_blank" class="btn-primary">
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marceli.to/Jamon.digital/Webroot/specialhydraulics.ferratec.ch/resources/views/web/pages/product/show.blade.php ENDPATH**/ ?>