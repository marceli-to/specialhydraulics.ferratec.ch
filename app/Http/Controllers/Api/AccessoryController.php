...
class AccessoryController extends Controller
{
  ...
  public function update(Tool $tool, ToolStoreRequest $request)
  {
    ...
    $tool->setTranslation('link_shop_ferratec', 'de', $request->input('link_shop_ferratec.de'));
    ...
    $tool->setTranslation('link_shop_ferratec', 'fr', $request->input('link_shop_ferratec.fr'));
    ...
    $tool->setTranslation('link_shop_ferratec', 'it', $request->input('link_shop_ferratec.it'));
